...
const ExamCountdown = () => {
  const exams: Exam[] = [
    ...
    { name: "AP ICET 2026", date: new Date("2026-05-20"), color: "from-green-500 to-emerald-500" },
    { name: "TS ICET 2026", date: new Date("2026-05-28"), color: "from-orange-500 to-amber-500" },
  ];
